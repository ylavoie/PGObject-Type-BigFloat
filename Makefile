# This Makefile is for the PGObject::Type::BigFloat extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PGObject/Type/BigFloat.pm]
#     AUTHOR => [q[Chris Travers <chris.travers@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[PGObject::Type::BigFloat]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], PGObject=>q[0], Math::BigFloat=>q[0] }
#     VERSION_FROM => q[lib/PGObject/Type/BigFloat.pm]
...
NAME_SYM = PGObject_Type_BigFloat
VERSION = 0.02
...
MAKE = make
FULLEXT = PGObject/Type/BigFloat
BASEEXT = BigFloat
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Type/BigFloat.pm
...
TO_INST_PM = lib/PGObject/Type/BigFloat.pm

PM_TO_BLIB = lib/PGObject/Type/BigFloat.pm \
...
DISTNAME = PGObject-Type-BigFloat
DISTVNAME = PGObject-Type-BigFloat-0.02
...
manifypods : pure_all  \
	lib/PGObject/Type/BigFloat.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Type/BigFloat.pm $(INST_MAN3DIR)/PGObject::Type::BigFloat.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Math::BigFloat wrappers for PGObject classes'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject-Type-BigFloat' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Math::BigFloat: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  PGObject: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 0.02' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "Math::BigFloat wrappers for PGObject classes",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject-Type-BigFloat",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Math::BigFloat" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "PGObject" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Math::BigFloat wrappers for PGObject classes</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Chris Travers &lt;chris.travers@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Math::BigFloat" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="PGObject::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Type/BigFloat.pm blib/lib/PGObject/Type/BigFloat.pm 
